...
public class Metadado extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9041551591315909275L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Metadado\",\"namespace\":\"io.confluent.developer.avro.out\",\"fields\":[{\"name\":\"tipo\",\"type\":\"string\",\"avro.java.string\":\"String\"},{\"name\":\"versao\",\"type\":\"string\",\"avro.java.string\":\"String\"}]}");
   ...
   */
  public static io.confluent.developer.avro.out.Metadado.Builder newBuilder() {
    return new io.confluent.developer.avro.out.Metadado.Builder();
  }
   ...
   * @return A new Metadado RecordBuilder
   */
  public static io.confluent.developer.avro.out.Metadado.Builder newBuilder(io.confluent.developer.avro.out.Metadado.Builder other) {
    return new io.confluent.developer.avro.out.Metadado.Builder(other);
  }
   ...
   * @return A new Metadado RecordBuilder
   */
  public static io.confluent.developer.avro.out.Metadado.Builder newBuilder(io.confluent.developer.avro.out.Metadado other) {
    return new io.confluent.developer.avro.out.Metadado.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Metadado>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.confluent.developer.avro.out.Metadado.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.confluent.developer.avro.out.Metadado other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.tipo)) {
        this.tipo = data().deepCopy(fields()[0].schema(), other.tipo);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.developer.avro.out.Metadado.Builder setTipo(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.developer.avro.out.Metadado.Builder clearTipo() {
      tipo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.developer.avro.out.Metadado.Builder setVersao(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.developer.avro.out.Metadado.Builder clearVersao() {
      versao = null;
